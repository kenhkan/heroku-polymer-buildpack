...
const css_slam_1 = require('css-slam');
    ...
    _transform(file, encoding, callback) {
        if (file.contents && file.path.endsWith(`${this.validExtension}`)) {
            try {
                ...
                logger.warn(`Unable to optimize ${this.validExtension} file ${file.path}`, { err: err });
            }
        }
        callback(null, file);
    }
...
class CSSOptimizeStream extends GenericOptimizeStream {
    constructor(options) {
        super('.css', css_slam_1.css, options);
    }
    _transform(file, encoding, callback) {
...
class HTMLOptimizeStream extends GenericOptimizeStream {
    constructor(options) {
        super('.html', html_minifier_1.minify, options);
    }
}
